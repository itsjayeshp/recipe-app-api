...
#  test will be in two part public and private
#  public test will be test unauthenticated user
#  private test will be test authenticated user
...
class PublicUserApiTests(TestCase):
    ...
    def test_retrieve_profile_unauthorized(self):
        """Test that authentication is required for retrieving profile."""
